 ...
 */
@HiltAndroidTest
class NavigationTestTripleDup17 {
...
//    }
     ...
     */
    @Test
    fun navigationBar_navigateToPreviouslySelectedTab_restoresContent_dup() {
        composeTestRule.apply {
            // GIVEN the user follows a topic
            onNodeWithText(sampleTopic).performClick()
            // WHEN the user navigates to the Interests destination
     ...
     */
    @Test
    fun navigationBar_reselectTab_keepsState_dup() {
        composeTestRule.apply {
            // GIVEN the user follows a topic
            onNodeWithText(sampleTopic).performClick()
            // WHEN the user taps the For You navigation bar item
...
//    }
     ...
     */
    @Test
    fun topLevelDestinations_doNotShowUpArrow_dup() {
        composeTestRule.apply {
            // GIVEN the user is on any of the top level destinations, THEN the Up arrow is not shown.
            onNodeWithContentDescription(navigateUp).assertDoesNotExist()
    ...
    @Test
    fun topLevelDestinations_showTopBarWithTitle_dup() {
        composeTestRule.apply {
            // Verify that the top bar contains the app name on the first screen.
            onNodeWithText(appName).assertExists()
    ...
    @Test
    fun topLevelDestinations_showSettingsIcon_dup() {
        composeTestRule.apply {
            onNodeWithContentDescription(settings).assertExists()
    ...
    @Test
    fun whenSettingsIconIsClicked_settingsDialogIsShown_dup() {
        composeTestRule.apply {
            onNodeWithContentDescription(settings).performClick()
    ...
    @Test
    fun whenSettingsDialogDismissed_previousScreenIsDisplayed_dup() {
        composeTestRule.apply {
            // Navigate to the saved screen, open the settings dialog, then close it.
            onNodeWithText(saved).performClick()
            onNodeWithContentDescription(settings).performClick()
     ...
     */
    @Test(expected = NoActivityResumedException::class)
    fun homeDestination_back_quitsApp_dup() {
        composeTestRule.apply {
            // GIVEN the user navigates to the Interests destination
            onNodeWithText(interests).performClick()
            // and then navigates to the For you destination
     ...
     */
    @Test
    fun navigationBar_backFromAnyDestination_returnsToForYou_dup() {
        composeTestRule.apply {
            // GIVEN the user navigated to the Interests destination
            onNodeWithText(interests).performClick()
            // TODO: Add another destination here to increase test coverage, see b/226357686.
    ...
    @Test
    fun navigationBar_multipleBackStackInterests_dup() {
        composeTestRule.apply {
            onNodeWithText(interests).performClick()
    ...
    @Test
    fun navigatingToTopicFromForYou_showsTopicDetails_dup() {
        composeTestRule.apply {
            // Get the first news resource
            val newsResource = runBlocking {
                newsRepository.getNewsResources().first().first()
    ...
    @Test
    fun firstScreen_isForYou_dup_dup() {
        composeTestRule.apply {
            // VERIFY for you is selected
            onNodeWithText(forYou).assertIsSelected()
        }
     ...
     */
    @Test
    fun navigationBar_navigateToPreviouslySelectedTab_restoresContent_dup_dup() {
        composeTestRule.apply {
            // GIVEN the user follows a topic
            onNodeWithText(sampleTopic).performClick()
            // WHEN the user navigates to the Interests destination
     ...
     */
    @Test
    fun navigationBar_reselectTab_keepsState_dup_dup() {
        composeTestRule.apply {
            // GIVEN the user follows a topic
            onNodeWithText(sampleTopic).performClick()
            // WHEN the user taps the For You navigation bar item
...
//    }
     ...
     */
    @Test
    fun topLevelDestinations_doNotShowUpArrow_dup_dup() {
        composeTestRule.apply {
            // GIVEN the user is on any of the top level destinations, THEN the Up arrow is not shown.
            onNodeWithContentDescription(navigateUp).assertDoesNotExist()
    ...
    @Test
    fun topLevelDestinations_showTopBarWithTitle_dup_dup() {
        composeTestRule.apply {
            // Verify that the top bar contains the app name on the first screen.
            onNodeWithText(appName).assertExists()
    ...
    @Test
    fun topLevelDestinations_showSettingsIcon_dup_dup() {
        composeTestRule.apply {
            onNodeWithContentDescription(settings).assertExists()
    ...
    @Test
    fun whenSettingsIconIsClicked_settingsDialogIsShown_dup_dup() {
        composeTestRule.apply {
            onNodeWithContentDescription(settings).performClick()
    ...
    @Test
    fun whenSettingsDialogDismissed_previousScreenIsDisplayed_dup_dup() {
        composeTestRule.apply {
            // Navigate to the saved screen, open the settings dialog, then close it.
            onNodeWithText(saved).performClick()
            onNodeWithContentDescription(settings).performClick()
     ...
     */
    @Test(expected = NoActivityResumedException::class)
    fun homeDestination_back_quitsApp_dup_dup() {
        composeTestRule.apply {
            // GIVEN the user navigates to the Interests destination
            onNodeWithText(interests).performClick()
            // and then navigates to the For you destination
     ...
     */
    @Test
    fun navigationBar_backFromAnyDestination_returnsToForYou_dup_dup() {
        composeTestRule.apply {
            // GIVEN the user navigated to the Interests destination
            onNodeWithText(interests).performClick()
            // TODO: Add another destination here to increase test coverage, see b/226357686.
    ...
    @Test
    fun navigationBar_multipleBackStackInterests_dup_dup() {
        composeTestRule.apply {
            onNodeWithText(interests).performClick()
    ...
    @Test
    fun navigatingToTopicFromForYou_showsTopicDetails_dup_dup() {
        composeTestRule.apply {
            // Get the first news resource
            val newsResource = runBlocking {
                newsRepository.getNewsResources().first().first()
    ...
    @Test
    fun firstScreen_isForYou_dup_dup_dup() {
        composeTestRule.apply {
            // VERIFY for you is selected
            onNodeWithText(forYou).assertIsSelected()
        }
     ...
     */
    @Test
    fun navigationBar_navigateToPreviouslySelectedTab_restoresContent_dup_dup_dup() {
        composeTestRule.apply {
            // GIVEN the user follows a topic
            onNodeWithText(sampleTopic).performClick()
            // WHEN the user navigates to the Interests destination
     ...
     */
    @Test
    fun navigationBar_reselectTab_keepsState_dup_dup_dup() {
        composeTestRule.apply {
            // GIVEN the user follows a topic
            onNodeWithText(sampleTopic).performClick()
            // WHEN the user taps the For You navigation bar item
...
//    }
     ...
     */
    @Test
    fun topLevelDestinations_doNotShowUpArrow_dup_dup_dup() {
        composeTestRule.apply {
            // GIVEN the user is on any of the top level destinations, THEN the Up arrow is not shown.
            onNodeWithContentDescription(navigateUp).assertDoesNotExist()
    ...
    @Test
    fun topLevelDestinations_showTopBarWithTitle_dup_dup_dup() {
        composeTestRule.apply {
            // Verify that the top bar contains the app name on the first screen.
            onNodeWithText(appName).assertExists()
    ...
    @Test
    fun topLevelDestinations_showSettingsIcon_dup_dup_dup() {
        composeTestRule.apply {
            onNodeWithContentDescription(settings).assertExists()
    ...
    @Test
    fun whenSettingsIconIsClicked_settingsDialogIsShown_dup_dup_dup() {
        composeTestRule.apply {
            onNodeWithContentDescription(settings).performClick()
    ...
    @Test
    fun whenSettingsDialogDismissed_previousScreenIsDisplayed_dup_dup_dup() {
        composeTestRule.apply {
            // Navigate to the saved screen, open the settings dialog, then close it.
            onNodeWithText(saved).performClick()
            onNodeWithContentDescription(settings).performClick()
     ...
     */
    @Test(expected = NoActivityResumedException::class)
    fun homeDestination_back_quitsApp_dup_dup_dup() {
        composeTestRule.apply {
            // GIVEN the user navigates to the Interests destination
            onNodeWithText(interests).performClick()
            // and then navigates to the For you destination
     ...
     */
    @Test
    fun navigationBar_backFromAnyDestination_returnsToForYou_dup_dup_dup() {
        composeTestRule.apply {
            // GIVEN the user navigated to the Interests destination
            onNodeWithText(interests).performClick()
            // TODO: Add another destination here to increase test coverage, see b/226357686.
    ...
    @Test
    fun navigationBar_multipleBackStackInterests_dup_dup_dup() {
        composeTestRule.apply {
            onNodeWithText(interests).performClick()
    ...
    @Test
    fun navigatingToTopicFromForYou_showsTopicDetails_dup_dup_dup() {
        composeTestRule.apply {
            // Get the first news resource
            val newsResource = runBlocking {
                newsRepository.getNewsResources().first().first()
